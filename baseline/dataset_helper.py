...
if __name__ == '__main__':
    ...
    generate_sense_inventory_json_by_counter(upmc_ad_train_counter, dataset_paths.upmc_ad_train_folder+"upmc_ad_train_inventory.json")
    generate_sense_inventory_json_by_counter(upmc_ad_test_counter, dataset_paths.upmc_ad_test_folder+"upmc_ad_test_inventory.json")
